...
public class Contrato implements Entidade{
    ...
    @NotNull(message = "{Contrato.dt_final.NotNull}")
    @Size(min = 1, max = 19, message = "{Contrato.dt_final.Size}") 
    ...
    public String toString() {
        return "Contrato{" + "id=" + id + ", documento=" + documento + ", fornecedor=" + fornecedor + ", servico=" + servico + ", unidade=" + unidade + ", diretoria=" + diretoria + ", email=" + email + ", indice=" + indice + ", reajuste=" + reajuste + ", dt_inicio=" + dt_inicio + ", dt_final=" + dt_final + ", observacoes=" + observacoes + '}';
    }
}
