(function(){
    ...
    function ContratoService($http) {
        ...
        function findAllOver() {
            return $http.get('http://localhost:8080/api/contratos/all?order=fornecedor')
         ...
         function findAll(filtro, page) {
            return $http.get('http://localhost:8080/api/contratos?page=' + page.number +
                    '&size=' + page.size + '&filterField=fornecedor&filterValue=' + filtro)
                .then(function (response) {
                    return {
                  ...
                  function findById(id) {
                      return $http.get('http://localhost:8080/api/contratos/' + id)
                          .then(function (response) {
                              return response.data;
                          });
                  }
                  ...
                  function insert(registro) {
                      return $http.post('http://localhost:8080/api/contratos', registro)
                          .then(function (response) {
                              return response.data;
                          });
                  }
                  ...
                  function update(registro) {
                      return $http.put('http://localhost:8080/api/contratos/' + registro.id, registro)
                          .then(function (response) {
                              return response.data;
                          });
                  }
                  ...
                  function remove(id) {
                      return $http.delete('http://localhost:8080/api/contratos/' + id)
                          .then(function (response) {
                              return response.data;
                          });
                  }
